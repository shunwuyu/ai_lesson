...
const App = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-gray-100'>
      {/* <AudioPlayer 
        audioUrl="https://cdn.freesound.org/previews/818/818988_12880153-lq.mp3"
        mimeType={'audio/mp3'}
      /> */}
      <div className='absolute z-50 top-0 left-0 w-full h-full transition-all px-8 flex flex-col justify-center text-center' style={{
        opacity: isLoading ? 1 : 0,
        // pointerEvents 是 CSS 属性，控制元素如何响应鼠标事件。
