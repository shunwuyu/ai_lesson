function App() {
  return (
    <div class="max-w-xs rounded-lg overflow-hidden shadow-lg bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto">
      <div class="relative">
        <img 
        ...
        <button class="absolute top-2 right-2 text-gray-500 hover:text-red-500 transition-colors">
      ...
      <div class="p-4">
        ...
        <div class="flex items-center mt-2">
          ...
          <span class="ml-1 text-xs text-gray-500">4.4 (128 reviews)</span>
        </div>
