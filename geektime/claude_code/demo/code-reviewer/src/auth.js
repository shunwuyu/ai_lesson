...
// 已修复: 从环境变量读取密钥，而不是硬编码
const SECRET_KEY = process.env.SECRET_KEY || throwIfMissing('SECRET_KEY');
const API_KEY = process.env.API_KEY || throwIfMissing('API_KEY');

// 辅助函数：确保必需的环境变量存在
function throwIfMissing(envVar) {
