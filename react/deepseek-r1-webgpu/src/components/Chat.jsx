...
import { marked } from "marked"; // markdown 支持
import DOMPurify from "dompurify"; // 清理和净化 HTML 字符串的 JavaScript 库，它可以帮助防止跨站脚本攻击（XSS）。
// 图标 svg 
...
function render(text) {
  ...
  // 在 Markdown 中，方括号和圆括号通常用于表示链接或图像的语法。例如，[链接文本](链接地址) 是一个 Markdown 链接的语法。
